 ...
 *    случае механизм уровеней можно упразднить.
 *
 ...
 *    (функция search_eepath), которое не гарантирует однозначную идетнификацию.
 * 
 *-------------------------------------------------------------------------
 */
...
/*
 * Функция поиска пути eepath, который соответсвует структуре Path.  
 *
 ...
 * Имеет смысл в будущем использовать более быстрый алгоритм (хэш-таблица?).
 * 

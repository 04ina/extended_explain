...
3. [Тесты](#тесты)
4. [Дополнительный материал](#дополнительный-материал)

# Инсталляция

Перед инсталляцией необходимо применить патч для postgres-а версии 18
...
SELECT * FROM ee.paths;
 query_id | subquery_type | subquery_id | rel_id | path_id |   path_type    | child_paths |    startup_cost    |     total_cost     | rows  | is_del | rel_name | indexoid 
----------+---------------+-------------+--------+---------+----------------+-------------+--------------------+--------------------+-------+--------+----------+----------
        1 |               |           1 |      1 |       1 | SeqScan        |             |                  0 |                 18 |  1000 | f      | t1       |         
        1 |               |           1 |      1 |       2 | IndexOnlyScan  |             |              0.275 |             46.275 |  1000 | f      | t1       |    50414
        1 |               |           1 |      1 |       3 | IndexOnlyScan  |             |              0.275 | 0.2956862745098039 |     1 | f      | t1       |    50414
        1 |               |           1 |      1 |       4 | BitmapHeapScan |             | 0.2839754901960784 |  4.296475490196078 |     1 | f      | t1       |         
        1 |               |           1 |      2 |       5 | SeqScan        |             |                  0 | 227.20000000000002 | 16320 | f      | t2       |         
        1 |               |           1 |      3 |       6 | MergeJoin      | {1,5}       |  1436.968161870994 |  1686.768161870994 | 16320 | f      |          |         
        1 |               |           1 |      3 |       7 | MergeJoin      | {2,5}       | 1369.4142404476836 | 1662.7142404476836 | 16320 | f      |          |         
        1 |               |           1 |      3 |       8 | HashJoin       | {1,5}       | 431.20000000000005 | 2654.8999999999996 | 16320 | f      |          |         
        1 |               |           1 |      3 |       9 | MergeJoin      | {5,1}       |  1436.968161870994 | 1763.3681618709938 | 16320 | f      |          |         
        1 |               |           1 |      3 |      10 | HashJoin       | {5,1}       |               30.5 |              482.1 | 16320 | f      |          |         
        1 |               |           1 |      4 |      11 | HashJoin       | {5,1}       |               30.5 |              482.1 | 16320 | f      |          |         
(11 rows)
```
